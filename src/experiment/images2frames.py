...
def resize_to_input_shape(img, n_frames=50):
    shape = (128, 128)
...
def process_scan(path, n_frames=50):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--modality", "-m", default='3d')
    ...
    for _, row in dataset.iterrows():
        ...
        if args.modality == '2d':
            ...
            np.save(fold_dir/f"{row['filename']}_frame{frame}.npy", img)
